...
public class AdminController {
	...
	//adminLogin
	public String adminLogin(@RequestBody AdminLogin rd) throws Exception
	{
		...
		//{
			//au=ts.loginService(tmp_EmailId,tmp_Pass);
		au=ts.loginService(tmp_EmailId,tmp_Pass);
		//}
	...
	/*
	 * @PostMapping("adminLogin1") public String adminLogin(@RequestBody AdminLogin
	 * rd) throws Exception { String tmp_EmailId=rd.getEmail(); String
	 * tmp_Pass=rd.getPassword();
	 * 
	 * if(tmp_EmailId !=null && tmp_Pass!=null) {
	 * ru=ts.loginService(tmp_EmailId,tmp_Pass); }
	 * 
	 * if(ru!=null) { return "User Signed In Successfully"; } else { throw new
